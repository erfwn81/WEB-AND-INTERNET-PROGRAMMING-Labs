			...
			<div class="divTable">
				<div class="divTableBody">
					<div class="divTableRow">
						...
						<% } else { %>
						<div class="divTableCell">
							<input type="text" placeholder="Please enter your email" name="email" id="email" value="<% out.println(request.getAttribute("email")); %>" required />
						</div>
						<% } %>
					</div>
					<div class="divTableRow">
						...
						<% } else { %>
						<div class="divTableCell">
							<input type="text" placeholder="Please enter your name" name="name" id="name" value="<% out.println(request.getAttribute("name")); %>" required />
						</div>
						<% } %>
					</div>
					<div class="divTableRow">
						...
						<% } else { %>
						<div class="divTableCell">
							<input type="password" placeholder="Please enter your password" name="password" id="password" value="<% out.println(request.getAttribute("password")); %>" required />
						</div>
						<% } %>
					</div>
				</div>
